...
class PriceTableBillingTypesRepository extends BaseRepository implements PriceTableBillingTypesRepositoryInterface
{

    function model(): string
    {
        return 'App\Models\PriceTableBillingType';
    }
